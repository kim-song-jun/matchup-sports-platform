# SC-LOGIN-INSTRUCTOR — Bootstrap instructor Playwright storage state via dev-login persona label
...
| STEP-02 | type | selector=[data-testid='dev-login-input']<br />value=${AUTOQA_INSTRUCTOR_LABEL} |
