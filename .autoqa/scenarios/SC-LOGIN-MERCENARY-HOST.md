# SC-LOGIN-MERCENARY-HOST — Bootstrap mercenary-host Playwright storage state via dev-login persona label
...
| STEP-02 | type | selector=[data-testid='dev-login-input']<br />value=${AUTOQA_MERCENARY_HOST_LABEL} |
