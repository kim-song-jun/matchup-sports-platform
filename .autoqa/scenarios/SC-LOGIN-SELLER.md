# SC-LOGIN-SELLER — Bootstrap seller Playwright storage state via dev-login persona label
...
| STEP-02 | type | selector=[data-testid='dev-login-input']<br />value=${AUTOQA_SELLER_LABEL} |
