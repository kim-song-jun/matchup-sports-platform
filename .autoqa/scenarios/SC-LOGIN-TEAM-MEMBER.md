# SC-LOGIN-TEAM-MEMBER — Bootstrap team-member Playwright storage state via dev-login persona label
...
| STEP-02 | type | selector=[data-testid='dev-login-input']<br />value=${AUTOQA_TEAM_MEMBER_LABEL} |
