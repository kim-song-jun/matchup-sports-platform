...
`docs/ops/prod-backup.md` documents the restore procedure for both paths and records what is still missing — backup failures are currently visible only in the journal, and no restore rehearsal has been done yet.
