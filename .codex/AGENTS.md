...
If a similar feature exists outside `apps/v1_api`, `apps/v1_web`, or `apps/v1_android`, ignore it unless the user explicitly asks for legacy cleanup or migration analysis.
