...
- 2026-09-11: Fixed popup/notice saves when Tiptap retains supported formatting marks on a hardBreak after a soft line break. The API now validates and preserves supported hardBreak marks while continuing to reject unknown or unsafe marks. Focused rich-content tests passed (26/26).
