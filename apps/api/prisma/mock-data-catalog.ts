...
export const DEV_MOCK_CATALOG_VERSION = 2;
  ...
  const users: MockUserRecord[] = [
    {
      ...
      gender: 'female',
      birthYear: 1997,
      bio: '빠른 템포의 풋살과 주말 픽업 경기를 좋아하는 dev mock captain입니다.',
    ...
    },
    {
      ...
      gender: 'male',
      birthYear: 1994,
      bio: '3대3 하프코트와 필름 리뷰를 즐기는 dev mock guard입니다.',
    ...
    },
    {
      ...
      gender: 'female',
      birthYear: 1998,
      bio: '클리어와 드라이브 연습을 좋아하는 dev mock racket player입니다.',
    ...
    },
    {
      ...
      gender: 'male',
      birthYear: 1992,
      bio: 'transition drill과 수비 로테이션에 강한 dev mock skater입니다.',
    ...
    },
    {
      ...
      gender: 'other',
      birthYear: 1996,
      bio: 'serve 루틴과 footwork drill 위주로 연습하는 dev mock coach입니다.',
    ...
    },
    {
      ...
      gender: 'male',
      birthYear: 1995,
      bio: '장비 거래와 팀 운영 보조를 동시에 하는 dev mock all-rounder입니다.',
    ...
    },
    {
      ...
      gender: 'male',
      birthYear: 1993,
      bio: '주말 11대11과 라인 간격 조율을 좋아하는 dev mock soccer captain입니다.',
    ...
    },
    {
      ...
      gender: 'male',
      birthYear: 1991,
      bio: '수비 시프트와 타석 운영을 즐기는 dev mock baseball captain입니다.',
    ...
    },
    {
      ...
      gender: 'female',
      birthYear: 1995,
      bio: '리시브 라인과 블로킹 타이밍을 세밀하게 맞추는 dev mock volleyball captain입니다.',
    ...
    },
    {
      ...
      gender: 'female',
      birthYear: 1990,
      bio: '페이스 유지와 기록 측정을 함께 관리하는 dev mock aquatics coach입니다.',
    ...
    },
    {
      ...
      gender: 'female',
      birthYear: 2000,
      bio: '엣지 컨트롤과 안무 디테일을 보는 dev mock skater입니다.',
    ...
    },
    {
      ...
      gender: 'male',
      birthYear: 1997,
      bio: '출발 반응과 레이스 운영을 중시하는 dev mock short track captain입니다.',
  ...
  const venues: MockVenueRecord[] = [
    {
      ...
      district: '마포구',
      phone: '02-300-4040',
      description: '목업 전용 풋살 허브. 야간 조명과 팀 라운지를 갖춘 검증용 venue입니다.',
    ...
    },
    {
      ...
      district: '용산구',
      phone: '02-410-5050',
      description: '목업 3대3와 하프코트 운영 화면을 검증하기 위한 실내 농구 코트입니다.',
    ...
    },
    {
      ...
      district: '서초구',
      phone: '02-520-6060',
      description: '배드민턴과 테니스 mock lesson/detail surface를 확인하기 위한 라켓 복합 공간입니다.',
    ...
    },
    {
      ...
      district: '송파구',
      phone: '02-424-7070',
      description: '아이스하키 mock team/team-match/mercenary surface를 위한 기준 링크입니다.',
    ...
    },
    {
      ...
      district: '서초구',
      phone: '02-590-8080',
      description: '테니스 mock profile/listing/lesson 카드의 기준 outdoor court입니다.',
    ...
    },
    {
      ...
      district: '양천구',
      phone: '02-620-8181',
      description: '11대11과 주말 교류전을 검증하기 위한 mock soccer ground입니다.',
    ...
    },
    {
      ...
      district: '구로구',
      phone: '02-710-9191',
      description: '배팅 케이지와 실내 수비 훈련 화면을 검증하는 mock baseball hub입니다.',
    ...
    },
    {
      ...
      district: '광진구',
      phone: '02-730-6262',
      description: '로테이션과 리시브 drill을 검증하기 위한 mock volleyball gym입니다.',
    ...
    },
    {
      ...
      district: '강동구',
      phone: '02-840-7373',
      description: 'lane booking과 pace session 화면을 검증하기 위한 mock aquatics center입니다.',
    ...
    },
    {
      ...
      district: '노원구',
      phone: '02-960-8484',
      description: 'figure / short track lesson과 mock session을 함께 검증하는 ice training lab입니다.',
  ...
  const teams: MockTeamRecord[] = [
    {
      ...
      name: '목업 성산 스트라이커즈',
      sportType: 'futsal',
      description: '성산/상암 기반 저녁 풋살 팀. 빠른 압박과 템포 유지가 장점인 mock squad입니다.',
      city: '서울',
      district: '마포구',
      level: 4,
      isRecruiting: true,
      contactInfo: '오픈카톡: mock-strikers',
      instagramUrl: 'https://instagram.com/mock.strikers',
      kakaoOpenChat: 'https://open.kakao.com/o/mockstrikers',
    },
    {
      key: 'nanjiPress',
      ...
      name: '목업 난지 프레스',
      sportType: 'futsal',
      description: '난지천 야간 친선전 위주로 움직이는 mock guest team입니다.',
      city: '서울',
      district: '강서구',
      level: 3,
      isRecruiting: true,
      contactInfo: '오픈카톡: mock-nanjipress',
      kakaoOpenChat: 'https://open.kakao.com/o/mocknanjipress',
    },
    {
      key: 'hardwoodSixmen',
      ...
      description: '3대3와 하프코트 운영을 검증하기 위한 mock basketball team입니다.',
      city: '서울',
      district: '용산구',
      level: 4,
      isRecruiting: true,
    ...
    },
    {
      ...
      name: '목업 셔틀 랩',
      sportType: 'badminton',
      description: '드릴, 복식 로테이션, 라켓 대여 플로우를 검증하기 위한 mock team입니다.',
      city: '서울',
      district: '서초구',
      level: 3,
      isRecruiting: true,
      contactInfo: '카카오톡: mock-shuttlelab',
    },
    {
      key: 'blueLine',
      ownerKey: 'iceLeader',
      ...
      description: '수비 전환과 장비 체크 flow를 검증하는 mock ice hockey team입니다.',
      city: '서울',
      district: '송파구',
      level: 5,
      isRecruiting: false,
      contactInfo: '오픈카톡: mock-blueline',
    },
    {
      key: 'mokdongEleven',
      ...
      name: '목업 목동 일레븐',
      sportType: 'soccer',
      description: '주말 11대11 교류전과 전술 보드를 검증하기 위한 mock soccer team입니다.',
      city: '서울',
      district: '양천구',
      level: 4,
      isRecruiting: true,
      contactInfo: '오픈카톡: mock-mokdongeleven',
      instagramUrl: 'https://instagram.com/mock.mokdongeleven',
    },
    {
      key: 'gocheokSluggers',
      ...
      name: '목업 고척 슬러거즈',
      sportType: 'baseball',
      description: '타순 운영과 장비 거래 플로우를 함께 검증하는 mock baseball club입니다.',
      city: '서울',
      district: '구로구',
      level: 4,
      isRecruiting: true,
      contactInfo: '오픈카톡: mock-sluggers',
    },
    {
      key: 'jayangBlockers',
      ...
      description: '리시브 라인과 로테이션 운영 화면을 검증하는 mock volleyball team입니다.',
      city: '서울',
      district: '광진구',
      level: 4,
      isRecruiting: true,
      contactInfo: '카카오톡: mock-jayangblockers',
    },
    {
      key: 'gangdongLanes',
      ...
      name: '목업 강동 레인즈',
      sportType: 'swimming',
      description: 'lane schedule과 기록 공유를 검증하는 mock swimming club입니다.',
      city: '서울',
      district: '강동구',
      level: 3,
      isRecruiting: true,
      contactInfo: '오픈카톡: mock-gangdonglanes',
    },
    {
      key: 'taereungEdges',
      ...
      description: 'ice session 운영과 pace control surface를 검증하는 mock short track team입니다.',
      city: '서울',
      district: '노원구',
      level: 4,
      isRecruiting: true,
      contactInfo: '오픈카톡: mock-taereungedges',
    },
  ];
  ...
  const matches: MockMatchRecord[] = [
    {
      ...
      sportType: 'futsal',
      title: '목업 화요일 풋살 6대6',
      description: '압박과 전환 속도를 보는 dev mock 픽업 경기입니다.',
      matchDate: in2Days,
      startTime: '20:00',
      endTime: '22:00',
      maxPlayers: 12,
    ...
    },
    {
      ...
      sportType: 'basketball',
      title: '목업 심야 하프코트 3대3',
      description: '템포와 spacing을 보는 dev mock 3대3입니다.',
      matchDate: in3Days,
      startTime: '21:00',
      endTime: '23:00',
      maxPlayers: 6,
    ...
    },
    {
      ...
      sportType: 'badminton',
      title: '목업 복식 로테이션 배드민턴',
      description: '라켓 대여와 입문자 가이드를 포함한 dev mock 복식 세션입니다.',
      matchDate: in4Days,
      startTime: '19:00',
      endTime: '21:00',
      maxPlayers: 4,
    ...
    },
    {
      ...
      sportType: 'ice_hockey',
      title: '목업 아이스하키 전환 훈련전',
      description: '라인 체인지와 수비 전환 체크용 dev mock scrim입니다.',
      matchDate: in6Days,
      startTime: '18:00',
      endTime: '20:00',
      maxPlayers: 10,
    ...
    },
    {
      ...
      sportType: 'tennis',
      title: '목업 새벽 테니스 랠리',
      description: '풋워크와 serve routine 체크용 dev mock 랠리 세션입니다.',
      matchDate: in7Days,
      startTime: '07:00',
      endTime: '09:00',
      maxPlayers: 4,
    ...
    },
    {
      ...
      sportType: 'soccer',
      title: '목업 주말 새벽 축구 11대11',
      description: '포지션 밸런스와 라인 간격을 확인하는 dev mock soccer session입니다.',
      matchDate: in5Days,
      startTime: '06:30',
      endTime: '08:30',
      maxPlayers: 22,
    ...
    },
    {
      ...
      sportType: 'baseball',
      title: '목업 실내 배팅 프랙티스',
      description: '배팅 케이지와 수비 포지션 전환을 보는 dev mock baseball session입니다.',
      matchDate: in4Days,
      startTime: '20:30',
      endTime: '22:30',
      maxPlayers: 10,
    ...
    },
    {
      ...
      sportType: 'volleyball',
      title: '목업 배구 로테이션 세션',
      description: '리시브 라인과 로테이션 타이밍을 맞추는 dev mock volleyball run입니다.',
      matchDate: in6Days,
      startTime: '19:30',
      endTime: '21:30',
      maxPlayers: 12,
    ...
    },
    {
      ...
      sportType: 'swimming',
      title: '목업 수영 페이스 세션',
      description: '기록 측정과 인터벌 pace 관리를 확인하는 dev mock lane session입니다.',
      matchDate: in3Days,
      startTime: '06:00',
      endTime: '07:30',
      maxPlayers: 8,
    ...
    },
    {
      ...
      title: '목업 피겨 엣지 컨트롤 세션',
      description: '엣지 전환과 스텝 시퀀스를 확인하는 dev mock figure session입니다.',
      matchDate: in7Days,
      startTime: '11:00',
      endTime: '13:00',
      maxPlayers: 6,
    ...
    },
    {
      ...
      sportType: 'short_track',
      title: '목업 쇼트트랙 릴레이 런',
      description: '스타트 반응과 릴레이 교대를 보는 dev mock short track run입니다.',
      matchDate: in9Days,
      startTime: '19:00',
      endTime: '21:00',
      maxPlayers: 8,
  ...
  const lessons: MockLessonRecord[] = [
    {
      ...
      sportType: 'futsal',
      type: 'clinic',
      title: '목업 풋살 압박 전환 클리닉',
      description: '전환 수비와 2터치 패턴을 훈련하는 dev mock clinic입니다.',
      lessonDate: in5Days,
      startTime: '19:30',
      endTime: '21:30',
      maxParticipants: 10,
      ...
      levelMax: 4,
      coachName: '목업 코치 민서',
      coachBio: '풋살 팀 운영과 세션 설계를 함께 검증하기 위한 mock coach profile입니다.',
      coachUserKey: 'futsalLeader',
      ticketPlans: [
        { name: '목업 체험 1회권', type: 'single', price: 28000, description: '첫 참가용 mock single ticket', sortOrder: 1 },
        { name: '목업 전환 4회권', type: 'multi', price: 96000, originalPrice: 112000, totalSessions: 4, description: '전환 드릴 반복용 mock pack', sortOrder: 2 },
      ],
    },
    {
      ...
      type: 'group_lesson',
      title: '목업 배드민턴 입문 랩',
      description: '그립, 서브, 로테이션을 단계별로 익히는 dev mock beginner class입니다.',
      lessonDate: in3Days,
      startTime: '18:30',
      endTime: '20:00',
      maxParticipants: 8,
      ...
      levelMax: 2,
      coachName: '목업 코치 서윤',
      coachBio: '배드민턴 입문 onboarding flow를 검증하기 위한 mock coach입니다.',
      coachUserKey: 'badmintonLeader',
      ticketPlans: [
        { name: '목업 스타터 1회권', type: 'single', price: 22000, description: '입문자용 single pass', sortOrder: 1 },
        { name: '목업 스타터 6회권', type: 'multi', price: 114000, originalPrice: 132000, totalSessions: 6, description: '입문 반복 수강용 mock pack', sortOrder: 2 },
      ],
    },
    {
      key: 'iceTransition',
      ...
      sportType: 'ice_hockey',
      type: 'group_lesson',
      title: '목업 아이스하키 전환 스케이팅',
      description: '블루라인 수비 전환과 스케이팅 자세를 집중 점검하는 dev mock class입니다.',
      lessonDate: in9Days,
      startTime: '14:00',
      endTime: '16:00',
      maxParticipants: 10,
      ...
      levelMax: 4,
      coachName: '목업 코치 유찬',
      coachBio: 'transition drill과 장비 체크 UX를 검증하는 mock ice coach입니다.',
      coachUserKey: 'iceLeader',
      ticketPlans: [
        { name: '목업 링크 체험권', type: 'single', price: 36000, description: '장비 포함 1회 mock pass', sortOrder: 1 },
        { name: '목업 링크 3회권', type: 'multi', price: 99000, originalPrice: 108000, totalSessions: 3, description: '기본 drill 반복용 pack', sortOrder: 2 },
      ],
    },
    {
      ...
      sportType: 'basketball',
      type: 'practice_match',
      title: '목업 농구 피니싱 실전 랩',
      description: 'closeout 이후 피니싱과 세컨드 액션을 보는 dev mock practice입니다.',
      lessonDate: in11Days,
      startTime: '20:30',
      endTime: '22:00',
      maxParticipants: 12,
      ...
      levelMax: 5,
      coachName: '목업 코치 하준',
      coachBio: '3대3 운영과 shot chart 설명용 mock basketball coach입니다.',
      coachUserKey: 'basketballLeader',
      ticketPlans: [
        { name: '목업 실전 1회권', type: 'single', price: 18000, description: '실전 피니싱 1회 pass', sortOrder: 1 },
        { name: '목업 실전 5회권', type: 'multi', price: 81000, originalPrice: 90000, totalSessions: 5, description: '반복 훈련용 mock pack', sortOrder: 2 },
      ],
    },
    {
      key: 'soccerFinishing',
      ...
      type: 'clinic',
      title: '목업 축구 피니싱 클리닉',
      description: '박스 안 움직임과 세컨드 볼 대응을 훈련하는 dev mock soccer clinic입니다.',
      lessonDate: in1Day,
      startTime: '19:00',
      endTime: '21:00',
      maxParticipants: 16,
      ...
      levelMax: 4,
      coachName: '목업 코치 도현',
      coachBio: '11대11 포지셔닝과 마무리 훈련을 검증하기 위한 mock soccer coach입니다.',
      coachUserKey: 'soccerCaptain',
      ticketPlans: [
        { name: '목업 축구 체험권', type: 'single', price: 26000, description: 'soccer finishing 1회권', sortOrder: 1 },
        { name: '목업 축구 4회권', type: 'multi', price: 94000, originalPrice: 104000, totalSessions: 4, description: '주말 finishing 반복 수강 pack', sortOrder: 2 },
      ],
    },
    {
      ...
      type: 'group_lesson',
      title: '목업 배구 리시브 랩',
      description: '서브 리시브와 블로킹 커버를 단계별로 익히는 dev mock volleyball class입니다.',
      lessonDate: in6Days,
      startTime: '18:30',
      endTime: '20:30',
      maxParticipants: 12,
      ...
      levelMax: 4,
      coachName: '목업 코치 예린',
      coachBio: 'rotation 설명과 receive drill flow를 검증하는 mock volleyball coach입니다.',
      coachUserKey: 'volleyballCaptain',
      ticketPlans: [
        { name: '목업 배구 1회권', type: 'single', price: 24000, description: 'volleyball receive 1회권', sortOrder: 1 },
        { name: '목업 배구 6회권', type: 'multi', price: 126000, originalPrice: 144000, totalSessions: 6, description: 'receive drill 반복 수강용 pack', sortOrder: 2 },
      ],
    },
    {
      key: 'swimInterval',
      ...
      type: 'clinic',
      title: '목업 수영 인터벌 클리닉',
      description: '100m 인터벌과 페이스 체크를 함께 검증하는 dev mock swim clinic입니다.',
      lessonDate: in4Days,
      startTime: '06:30',
      endTime: '08:00',
      maxParticipants: 10,
      ...
      levelMax: 5,
      coachName: '목업 코치 가은',
      coachBio: 'lap split과 기록 체크 UX를 검증하는 mock swim coach입니다.',
      coachUserKey: 'swimmerCoach',
      ticketPlans: [
        { name: '목업 수영 1회권', type: 'single', price: 30000, description: 'swim interval 1회권', sortOrder: 1 },
        { name: '목업 수영 8회권', type: 'multi', price: 208000, originalPrice: 240000, totalSessions: 8, description: '장기 인터벌 훈련 pack', sortOrder: 2 },
      ],
    },
    {
      key: 'figureEdge',
      ...
      type: 'group_lesson',
      title: '목업 피겨 엣지 워크숍',
      description: 'inside/outside edge와 turns를 집중 점검하는 dev mock figure workshop입니다.',
      lessonDate: in9Days,
      startTime: '15:00',
      endTime: '17:00',
      maxParticipants: 8,
      ...
      levelMax: 4,
      coachName: '목업 코치 하린',
      coachBio: 'edge drill과 프로그램 설명 flow를 검증하는 mock figure coach입니다.',
      coachUserKey: 'figureSkater',
      ticketPlans: [
        { name: '목업 피겨 1회권', type: 'single', price: 34000, description: 'figure edge 1회권', sortOrder: 1 },
        { name: '목업 피겨 3회권', type: 'multi', price: 93000, originalPrice: 102000, totalSessions: 3, description: 'edge 집중 워크숍 pack', sortOrder: 2 },
      ],
    },
  ];
  ...
  const listings: MockListingRecord[] = [
    {
      ...
      title: '목업 인도어 풋살화 265',
      description: '목업 장터 카드와 상세 페이지 검증용 인도어 풋살화입니다.',
      sportType: 'futsal',
      category: '풋살화',
      condition: 'good',
      price: 48000,
    ...
    },
    {
      ...
      title: '목업 팀 농구 유니폼 세트',
      description: '목업 팀 관리와 장터 flow를 확인하기 위한 유니폼 세트입니다.',
      sportType: 'basketball',
      category: '유니폼',
      condition: 'like_new',
      price: 68000,
    ...
    },
    {
      ...
      title: '목업 배드민턴 라켓 렌탈',
      description: '입문 lesson과 연결해서 보기 좋은 mock rental listing입니다.',
      sportType: 'badminton',
      category: '라켓',
      condition: 'good',
      price: 12000,
    ...
    },
    {
      ...
      sellerKey: 'iceLeader',
      title: '목업 하키 골리 글러브',
      description: '수비/장비 검증용 mock goalie glove listing입니다.',
      sportType: 'ice_hockey',
      category: '보호장비',
      condition: 'fair',
      price: 82000,
    ...
    },
    {
      ...
      title: '목업 테니스 라켓백',
      description: '테니스 lesson/profile surface와 함께 보기 좋은 mock gear listing입니다.',
      sportType: 'tennis',
      category: '가방',
      condition: 'like_new',
      price: 39000,
    ...
    },
    {
      ...
      title: '목업 축구 신가드 세트',
      description: 'soccer match/detail/card에서 함께 보기 좋은 mock shin guard listing입니다.',
      sportType: 'soccer',
      category: '보호장비',
      condition: 'like_new',
      price: 26000,
    ...
    },
    {
      ...
      title: '목업 야구 배트 렌탈',
      description: '배팅 케이지 입문자용 mock baseball rental listing입니다.',
      sportType: 'baseball',
      category: '배트',
      condition: 'good',
      price: 15000,
    ...
    },
    {
      ...
      title: '목업 배구공 공동구매',
      description: '팀 운영자용 mock group-buy listing으로 볼 수량과 모집 상태를 함께 검증합니다.',
      sportType: 'volleyball',
      category: '배구공',
      condition: 'new',
      price: 23000,
    ...
    },
    {
      ...
      title: '목업 수영 킥보드 세트',
      description: 'lane session과 수영 레슨 화면에서 함께 보기 좋은 mock swim gear listing입니다.',
      sportType: 'swimming',
      category: '훈련도구',
      condition: 'good',
      price: 34000,
    ...
    },
    {
      ...
      title: '목업 피겨 블레이드 케이스',
      description: 'ice training detail과 함께 노출하기 좋은 mock figure accessory listing입니다.',
      sportType: 'figure_skating',
      category: '액세서리',
      condition: 'like_new',
      price: 42000,
  ...
  const mercenaryPosts: MockMercenaryRecord[] = [
    {
      ...
      level: 3,
      fee: 20000,
      notes: '도착 체크와 골키퍼 slot 검증용 mock 공고입니다.',
    },
    {
      key: 'basketballWing',
      ...
      level: 4,
      fee: 15000,
      notes: '3대3 wing rotation mock 공고입니다.',
    },
    {
      key: 'iceDefense',
      teamKey: 'blueLine',
      ...
      level: 4,
      fee: 30000,
      notes: 'blue line coverage 검증용 mock 공고입니다.',
    },
    {
      ...
      level: 2,
      fee: 10000,
      notes: '복식 파트너 매칭 검증용 mock 공고입니다.',
    },
    {
      key: 'soccerStriker',
      ...
      level: 3,
      fee: 25000,
      notes: '박스 안 움직임과 마무리 검증용 mock 축구 공고입니다.',
    },
    {
      key: 'baseballCatcher',
      ...
      sportType: 'baseball',
      matchDate: in6Days,
      venue: '목업 고척 다이아몬드 허브',
      position: 'C',
      count: 1,
      level: 4,
      fee: 22000,
      notes: '배팅 케이지 수비 로테이션 검증용 mock 야구 공고입니다.',
    },
    {
      ...
      level: 3,
      fee: 18000,
      notes: '블로킹 타이밍 검증용 mock 배구 공고입니다.',
    },
    {
      key: 'shortTrackPacer',
      ...
      level: 4,
      fee: 26000,
      notes: '릴레이 pace 조율 검증용 mock 쇼트트랙 공고입니다.',
    },
  ];
  ...
  const teamMatches: MockTeamMatchRecord[] = [
    {
      ...
      sportType: 'futsal',
      title: '목업 토요일 풋살 스크림',
      description: '팀 매치 신청/승인 화면을 검증하는 canonical mock fixture입니다.',
      matchDate: in6Days,
      startTime: '18:00',
      endTime: '20:00',
      totalMinutes: 120,
      quarterCount: 4,
      venueName: '목업 성산 풋살 허브',
    ...
    },
    {
      ...
      sportType: 'basketball',
      title: '목업 평일 3대3 챌린지',
      description: 'team-match operational page를 검증하는 mock challenge입니다.',
      matchDate: in7Days,
      startTime: '20:00',
      endTime: '22:00',
      totalMinutes: 120,
      quarterCount: 4,
      venueName: '목업 한강 하드우드 코트',
    ...
    },
    {
      ...
      sportType: 'badminton',
      title: '목업 복식 교류전 데이',
      description: '배드민턴 팀 매치 카드와 운영 카피를 보기 위한 mock event입니다.',
      matchDate: in11Days,
      startTime: '10:00',
      endTime: '13:00',
      totalMinutes: 180,
      quarterCount: 6,
      venueName: '목업 서초 라켓 스튜디오',
    ...
    },
    {
      ...
      sportType: 'soccer',
      title: '목업 주말 축구 교류전',
      description: '11대11 soccer team-match surface를 검증하는 canonical mock fixture입니다.',
      matchDate: in7Days,
      startTime: '18:00',
      endTime: '20:00',
      totalMinutes: 120,
      quarterCount: 2,
      venueName: '목업 목동 사커 그라운드',
    ...
    },
    {
      ...
      sportType: 'baseball',
      title: '목업 일요 야구 게임',
      description: 'baseball 팀 운영과 참가 안내 카피를 검증하는 mock team match입니다.',
      matchDate: in11Days,
      startTime: '13:00',
      endTime: '16:00',
      totalMinutes: 180,
      quarterCount: 9,
      venueName: '목업 고척 다이아몬드 허브',
    ...
    },
    {
      ...
      sportType: 'volleyball',
      title: '목업 배구 오픈 스크림',
      description: '배구 팀 소개와 운영 카피를 검증하는 mock volleyball scrim입니다.',
      matchDate: in9Days,
      startTime: '19:00',
      endTime: '21:30',
      totalMinutes: 150,
      quarterCount: 5,
      venueName: '목업 자양 스파이크 센터',
  ...
  const teamBadges: MockTeamBadgeRecord[] = [
    {
      ...
      type: 'manner_player',
      name: '매너 플레이어',
      description: 'mock 팀 평가 기준에서 매너 점수가 높은 팀입니다.',
    },
    {
      teamKey: 'shuttleLab',
      type: 'newcomer',
      name: '신생팀',
      description: 'mock onboarding flow에서 새로 등록된 팀입니다.',
    },
    {
      teamKey: 'blueLine',
      type: 'referee_hero',
      name: '심판 영웅',
      description: 'mock team match 운영에서 심판 봉사를 자주 수행한 팀입니다.',
    },
    {
      teamKey: 'mokdongEleven',
      type: 'honest_team',
      name: '정직한 팀',
      description: '라인업 고지와 경기 정보 설명이 안정적인 mock soccer team입니다.',
    },
    {
      teamKey: 'gocheokSluggers',
      type: 'punctual',
      name: '시간 약속',
      description: '장비 준비와 집합 시간이 안정적인 mock baseball club입니다.',
    },
    {
      teamKey: 'gangdongLanes',
      type: 'newcomer',
      name: '신생 클럽',
      description: 'lane 운영과 기록 공유를 막 시작한 mock swimming club입니다.',
    },
  ];
