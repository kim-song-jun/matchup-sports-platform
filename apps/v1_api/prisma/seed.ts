...
async function seedRegions() {
  ...
  const parentCodes = parents.map(([code]) => code);

  await prisma.v1Region.updateMany({
    where: { level: 1, code: { notIn: parentCodes } },
    data: { isActive: false },
  });
  ...
  const childRegions = [
    ...
    ['busan', 'busan-jung', '중구', 1, null, null],
    ['busan', 'busan-seo', '서구', 2, null, null],
    ['busan', 'busan-dong', '동구', 3, null, null],
    ['busan', 'busan-yeongdo', '영도구', 4, null, null],
    ['busan', 'busan-busanjin', '부산진구', 5, null, null],
    ['busan', 'busan-dongnae', '동래구', 6, null, null],
    ['busan', 'busan-nam', '남구', 7, null, null],
    ['busan', 'busan-buk', '북구', 8, null, null],
    ['busan', 'busan-haeundae', '해운대구', 9, null, null],
    ['busan', 'busan-saha', '사하구', 10, null, null],
    ['busan', 'busan-geumjeong', '금정구', 11, null, null],
    ['busan', 'busan-gangseo', '강서구', 12, null, null],
    ['busan', 'busan-yeonje', '연제구', 13, null, null],
    ['busan', 'busan-suyeong', '수영구', 14, null, null],
    ['busan', 'busan-sasang', '사상구', 15, null, null],
    ['busan', 'busan-gijang', '기장군', 16, null, null],
    ['daegu', 'daegu-jung', '중구', 1, null, null],
    ['daegu', 'daegu-dong', '동구', 2, null, null],
    ['daegu', 'daegu-seo', '서구', 3, null, null],
    ['daegu', 'daegu-nam', '남구', 4, null, null],
    ['daegu', 'daegu-buk', '북구', 5, null, null],
    ['daegu', 'daegu-suseong', '수성구', 6, null, null],
    ['daegu', 'daegu-dalseo', '달서구', 7, null, null],
    ['daegu', 'daegu-dalseong', '달성군', 8, null, null],
    ['daegu', 'daegu-gunwi', '군위군', 9, null, null],
    ['incheon', 'incheon-jung', '중구', 1, null, null],
    ['incheon', 'incheon-dong', '동구', 2, null, null],
    ['incheon', 'incheon-michuhol', '미추홀구', 3, null, null],
    ['incheon', 'incheon-yeonsu', '연수구', 4, null, null],
    ['incheon', 'incheon-namdong', '남동구', 5, null, null],
    ['incheon', 'incheon-bupyeong', '부평구', 6, null, null],
    ['incheon', 'incheon-gyeyang', '계양구', 7, null, null],
    ['incheon', 'incheon-seo', '서구', 8, null, null],
    ['incheon', 'incheon-ganghwa', '강화군', 9, null, null],
    ['incheon', 'incheon-ongjin', '옹진군', 10, null, null],
    ['gwangju', 'gwangju-dong', '동구', 1, null, null],
    ['gwangju', 'gwangju-seo', '서구', 2, null, null],
    ['gwangju', 'gwangju-nam', '남구', 3, null, null],
    ['gwangju', 'gwangju-buk', '북구', 4, null, null],
    ['gwangju', 'gwangju-gwangsan', '광산구', 5, null, null],
    ['daejeon', 'daejeon-dong', '동구', 1, null, null],
    ['daejeon', 'daejeon-jung', '중구', 2, null, null],
    ['daejeon', 'daejeon-seo', '서구', 3, null, null],
    ['daejeon', 'daejeon-yuseong', '유성구', 4, null, null],
    ['daejeon', 'daejeon-daedeok', '대덕구', 5, null, null],
    ['ulsan', 'ulsan-jung', '중구', 1, null, null],
    ['ulsan', 'ulsan-nam', '남구', 2, null, null],
    ['ulsan', 'ulsan-dong', '동구', 3, null, null],
    ['ulsan', 'ulsan-buk', '북구', 4, null, null],
    ['ulsan', 'ulsan-ulju', '울주군', 5, null, null],
    ['sejong', 'sejong-city', '세종시', 1, null, null],
    ['gangwon', 'gangwon-chuncheon', '춘천시', 1, null, null],
    ['gangwon', 'gangwon-wonju', '원주시', 2, null, null],
    ['gangwon', 'gangwon-gangneung', '강릉시', 3, null, null],
    ['gangwon', 'gangwon-donghae', '동해시', 4, null, null],
    ['gangwon', 'gangwon-taebaek', '태백시', 5, null, null],
    ['gangwon', 'gangwon-sokcho', '속초시', 6, null, null],
    ['gangwon', 'gangwon-samcheok', '삼척시', 7, null, null],
    ['gangwon', 'gangwon-hongcheon', '홍천군', 8, null, null],
    ['gangwon', 'gangwon-hoengseong', '횡성군', 9, null, null],
    ['gangwon', 'gangwon-yeongwol', '영월군', 10, null, null],
    ['gangwon', 'gangwon-pyeongchang', '평창군', 11, null, null],
    ['gangwon', 'gangwon-jeongseon', '정선군', 12, null, null],
    ['gangwon', 'gangwon-cheorwon', '철원군', 13, null, null],
    ['gangwon', 'gangwon-hwacheon', '화천군', 14, null, null],
    ['gangwon', 'gangwon-yanggu', '양구군', 15, null, null],
    ['gangwon', 'gangwon-inje', '인제군', 16, null, null],
    ['gangwon', 'gangwon-goseong', '고성군', 17, null, null],
    ['gangwon', 'gangwon-yangyang', '양양군', 18, null, null],
    ['chungbuk', 'chungbuk-cheongju', '청주시', 1, null, null],
    ['chungbuk', 'chungbuk-chungju', '충주시', 2, null, null],
    ['chungbuk', 'chungbuk-jecheon', '제천시', 3, null, null],
    ['chungbuk', 'chungbuk-boeun', '보은군', 4, null, null],
    ['chungbuk', 'chungbuk-okcheon', '옥천군', 5, null, null],
    ['chungbuk', 'chungbuk-yeongdong', '영동군', 6, null, null],
    ['chungbuk', 'chungbuk-jeungpyeong', '증평군', 7, null, null],
    ['chungbuk', 'chungbuk-jincheon', '진천군', 8, null, null],
    ['chungbuk', 'chungbuk-goesan', '괴산군', 9, null, null],
    ['chungbuk', 'chungbuk-eumseong', '음성군', 10, null, null],
    ['chungbuk', 'chungbuk-danyang', '단양군', 11, null, null],
    ['chungnam', 'chungnam-cheonan', '천안시', 1, null, null],
    ['chungnam', 'chungnam-gongju', '공주시', 2, null, null],
    ['chungnam', 'chungnam-boryeong', '보령시', 3, null, null],
    ['chungnam', 'chungnam-asan', '아산시', 4, null, null],
    ['chungnam', 'chungnam-seosan', '서산시', 5, null, null],
    ['chungnam', 'chungnam-nonsan', '논산시', 6, null, null],
    ['chungnam', 'chungnam-gyeryong', '계룡시', 7, null, null],
    ['chungnam', 'chungnam-dangjin', '당진시', 8, null, null],
    ['chungnam', 'chungnam-geumsan', '금산군', 9, null, null],
    ['chungnam', 'chungnam-buyeo', '부여군', 10, null, null],
    ['chungnam', 'chungnam-seocheon', '서천군', 11, null, null],
    ['chungnam', 'chungnam-cheongyang', '청양군', 12, null, null],
    ['chungnam', 'chungnam-hongseong', '홍성군', 13, null, null],
    ['chungnam', 'chungnam-yesan', '예산군', 14, null, null],
    ['chungnam', 'chungnam-taean', '태안군', 15, null, null],
    ['jeonbuk', 'jeonbuk-jeonju', '전주시', 1, null, null],
    ['jeonbuk', 'jeonbuk-gunsan', '군산시', 2, null, null],
    ['jeonbuk', 'jeonbuk-iksan', '익산시', 3, null, null],
    ['jeonbuk', 'jeonbuk-jeongeup', '정읍시', 4, null, null],
    ['jeonbuk', 'jeonbuk-namwon', '남원시', 5, null, null],
    ['jeonbuk', 'jeonbuk-gimje', '김제시', 6, null, null],
    ['jeonbuk', 'jeonbuk-wanju', '완주군', 7, null, null],
    ['jeonbuk', 'jeonbuk-jinan', '진안군', 8, null, null],
    ['jeonbuk', 'jeonbuk-muju', '무주군', 9, null, null],
    ['jeonbuk', 'jeonbuk-jangsu', '장수군', 10, null, null],
    ['jeonbuk', 'jeonbuk-imsil', '임실군', 11, null, null],
    ['jeonbuk', 'jeonbuk-sunchang', '순창군', 12, null, null],
    ['jeonbuk', 'jeonbuk-gochang', '고창군', 13, null, null],
    ['jeonbuk', 'jeonbuk-buan', '부안군', 14, null, null],
    ['jeonnam', 'jeonnam-mokpo', '목포시', 1, null, null],
    ['jeonnam', 'jeonnam-yeosu', '여수시', 2, null, null],
    ['jeonnam', 'jeonnam-suncheon', '순천시', 3, null, null],
    ['jeonnam', 'jeonnam-naju', '나주시', 4, null, null],
    ['jeonnam', 'jeonnam-gwangyang', '광양시', 5, null, null],
    ['jeonnam', 'jeonnam-damyang', '담양군', 6, null, null],
    ['jeonnam', 'jeonnam-gokseong', '곡성군', 7, null, null],
    ['jeonnam', 'jeonnam-gurye', '구례군', 8, null, null],
    ['jeonnam', 'jeonnam-goheung', '고흥군', 9, null, null],
    ['jeonnam', 'jeonnam-boseong', '보성군', 10, null, null],
    ['jeonnam', 'jeonnam-hwasun', '화순군', 11, null, null],
    ['jeonnam', 'jeonnam-jangheung', '장흥군', 12, null, null],
    ['jeonnam', 'jeonnam-gangjin', '강진군', 13, null, null],
    ['jeonnam', 'jeonnam-haenam', '해남군', 14, null, null],
    ['jeonnam', 'jeonnam-yeongam', '영암군', 15, null, null],
    ['jeonnam', 'jeonnam-muan', '무안군', 16, null, null],
    ['jeonnam', 'jeonnam-hampyeong', '함평군', 17, null, null],
    ['jeonnam', 'jeonnam-yeonggwang', '영광군', 18, null, null],
    ['jeonnam', 'jeonnam-jangseong', '장성군', 19, null, null],
    ['jeonnam', 'jeonnam-wando', '완도군', 20, null, null],
    ['jeonnam', 'jeonnam-jindo', '진도군', 21, null, null],
    ['jeonnam', 'jeonnam-sinan', '신안군', 22, null, null],
    ['gyeongbuk', 'gyeongbuk-pohang', '포항시', 1, null, null],
    ['gyeongbuk', 'gyeongbuk-gyeongju', '경주시', 2, null, null],
    ['gyeongbuk', 'gyeongbuk-gimcheon', '김천시', 3, null, null],
    ['gyeongbuk', 'gyeongbuk-andong', '안동시', 4, null, null],
    ['gyeongbuk', 'gyeongbuk-gumi', '구미시', 5, null, null],
    ['gyeongbuk', 'gyeongbuk-yeongju', '영주시', 6, null, null],
    ['gyeongbuk', 'gyeongbuk-yeongcheon', '영천시', 7, null, null],
    ['gyeongbuk', 'gyeongbuk-sangju', '상주시', 8, null, null],
    ['gyeongbuk', 'gyeongbuk-mungyeong', '문경시', 9, null, null],
    ['gyeongbuk', 'gyeongbuk-gyeongsan', '경산시', 10, null, null],
    ['gyeongbuk', 'gyeongbuk-uiseong', '의성군', 11, null, null],
    ['gyeongbuk', 'gyeongbuk-cheongsong', '청송군', 12, null, null],
    ['gyeongbuk', 'gyeongbuk-yeongyang', '영양군', 13, null, null],
    ['gyeongbuk', 'gyeongbuk-yeongdeok', '영덕군', 14, null, null],
    ['gyeongbuk', 'gyeongbuk-cheongdo', '청도군', 15, null, null],
    ['gyeongbuk', 'gyeongbuk-goryeong', '고령군', 16, null, null],
    ['gyeongbuk', 'gyeongbuk-seongju', '성주군', 17, null, null],
    ['gyeongbuk', 'gyeongbuk-chilgok', '칠곡군', 18, null, null],
    ['gyeongbuk', 'gyeongbuk-yecheon', '예천군', 19, null, null],
    ['gyeongbuk', 'gyeongbuk-bonghwa', '봉화군', 20, null, null],
    ['gyeongbuk', 'gyeongbuk-uljin', '울진군', 21, null, null],
    ['gyeongbuk', 'gyeongbuk-ulleung', '울릉군', 22, null, null],
    ['gyeongnam', 'gyeongnam-changwon', '창원시', 1, null, null],
    ['gyeongnam', 'gyeongnam-jinju', '진주시', 2, null, null],
    ['gyeongnam', 'gyeongnam-tongyeong', '통영시', 3, null, null],
    ['gyeongnam', 'gyeongnam-sacheon', '사천시', 4, null, null],
    ['gyeongnam', 'gyeongnam-gimhae', '김해시', 5, null, null],
    ['gyeongnam', 'gyeongnam-miryang', '밀양시', 6, null, null],
    ['gyeongnam', 'gyeongnam-geoje', '거제시', 7, null, null],
    ['gyeongnam', 'gyeongnam-yangsan', '양산시', 8, null, null],
    ['gyeongnam', 'gyeongnam-uiryeong', '의령군', 9, null, null],
    ['gyeongnam', 'gyeongnam-haman', '함안군', 10, null, null],
    ['gyeongnam', 'gyeongnam-changnyeong', '창녕군', 11, null, null],
    ['gyeongnam', 'gyeongnam-goseong', '고성군', 12, null, null],
    ['gyeongnam', 'gyeongnam-namhae', '남해군', 13, null, null],
    ['gyeongnam', 'gyeongnam-hadong', '하동군', 14, null, null],
    ['gyeongnam', 'gyeongnam-sancheong', '산청군', 15, null, null],
    ['gyeongnam', 'gyeongnam-hamyang', '함양군', 16, null, null],
    ['gyeongnam', 'gyeongnam-geochang', '거창군', 17, null, null],
    ['gyeongnam', 'gyeongnam-hapcheon', '합천군', 18, null, null],
    ['jeju', 'jeju-jeju', '제주시', 1, null, null],
    ['jeju', 'jeju-seogwipo', '서귀포시', 2, null, null],
  ] as const;
