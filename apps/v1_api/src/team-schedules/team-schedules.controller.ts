...
/**
 * Owns exactly the "schedule CRUD / versioned mutate / cancel" lane routes of the frozen
 * contract (docs/api/global-contract.md). Sibling lanes are standalone controllers that also
 * delegate to the shared TeamSchedulesService, each registered separately in
