  ...
  return {
    v1GameResultRevision: {
      findUnique: jest.fn().mockResolvedValue({
        ...
        game: { sourceType: 'TEAM_MATCH', teamMatchId: repairInput.fixtureId },
        officialFact: {
          revision: 1,
          gameId: repairInput.gameId,
          sourceType: 'TEAM_MATCH',
          tournamentId: repairInput.tournamentId,
          homeTeamId: repairInput.homeTeamId,
          awayTeamId: repairInput.awayTeamId,
          eventsHash: 'old-hash',
          officialAt: repairInput.recordedAt,
        },
    ...
    v1ParticipantIdentityLinkCurrent: { findUnique: jest.fn().mockResolvedValue(null), upsert: jest.fn().mockResolvedValue({}) },
