...
export const gameSchemaSourceManifest = {
  ...
  // 2026-08-20 재핀: 대회 팝업 통합 -- V1TournamentPopup 모델에 "수축 대기" 주석만 덧붙였다.
  // 모델·필드·인덱스는 그대로이고 주석 줄만 늘었으므로 DB 스키마 변화는 없다(뒷받침 마이그레이션
  // 없음). 실제 DROP TABLE 은 이 릴리스가 배포돼 모든 컨테이너가 그 테이블을 읽지 않게 된 뒤
  // 별도 릴리스에서 한다. game domain 모델과 바인딩된 게임 마이그레이션은 건드리지 않았다.
  schema: '8c7101d75d41df3280f89fc900ab97110c21238bb9068971a413a1e0087c8889',
