...
import { useV1ActivePopup, useV1Team, useV1TeamMatchSeries, useV1TeamMatchSeriesPlayerRecords, useV1TeamMatchSeriesStandings } from '@/hooks/use-v1-api';
...
const useV1TeamMock = vi.mocked(useV1Team, { partial: true });
...
describe('TeamMatchSeriesStandingsClient', () => {
  it('미확정 경기가 있으면 순위표 대신 확인 중 안내를 보여준다', async () => {
    ...
    useV1TeamMock.mockReturnValue({ data: undefined } as never);
