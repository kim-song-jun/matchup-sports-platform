...
export const metadata: Metadata = buildNoIndexMetadata('대진표를 찾을 수 없어요');

export default function TournamentBracketNotFound() {
  return (
    <AppChrome title="순위·브래킷" activeTab="tournaments" backHref="/tournaments" showNotifications={false} desktopHead>
      <section
