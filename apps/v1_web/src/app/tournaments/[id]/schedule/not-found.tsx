...
export const metadata: Metadata = buildNoIndexMetadata('대회 일정을 찾을 수 없어요');

export default function TournamentScheduleNotFound() {
  return (
    <AppChrome title="경기 일정" activeTab="tournaments" backHref="/tournaments" showNotifications={false} desktopHead>
      <section
