...
function TeamMatchCard({ match }: { match: TeamMatchModel }) {
  ...
  // 마감된 팀매치도 경기 시작 전까지 목록에 남는다 — 배지만으로는 스크롤 중에 안 걸리므로
  // 카드 지면·사진도 함께 눌러 한눈에 갈리게 한다.
