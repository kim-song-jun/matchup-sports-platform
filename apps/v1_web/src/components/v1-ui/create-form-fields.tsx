 ...
 *
 * `DraggableFilterSheet`(BottomSheet를 감싸던 공유 wrapper)는 matches-page.tsx·
 * team-matches-page.tsx·teams-page.tsx 세 소비처가 전부 `@/components/v1-ui/bottom-sheet`의
 * `BottomSheet`를 직접 import 하도록 바뀌면서 소비처가 0이 됐다 — 여기서 삭제한다
 * (CLAUDE.md 기술부채 0: 같은 변경에서 발생한 dead export는 같은 변경에서 없앤다).
 */
