...
export type RecordChange = { id: string; version: number; action: string; actorName: string; goalId: string | null; before: SharedGoal | null; after: SharedGoal | null; at: string };
...
export type RecordCommand = { commandId: string; expectedVersion: number; action: 'add' | 'edit' | 'delete' | 'undo' | 'confirm' | 'reopen'; goalId?: string; changeId?: string; sideId?: string; participantId?: string | null; ownGoal?: boolean; minute?: number | null };
