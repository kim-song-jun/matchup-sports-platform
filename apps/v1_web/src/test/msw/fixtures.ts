...
export const v1OpsEventsFixture = [
  {
    caseEventId: 'case-event-1',
  ...
  },
  {
    ...
    payoutAttemptId: 'payout-1',
    actorAdminUserId: 'admin-1',
    actorUserId: null,
    fromStatus: 'requested',
    toStatus: 'failed',
    reason: '지급대행 계약 미준비',
    metadata: { code: 'TOSS_PAYOUT_CONTRACT_REQUIRED' },
    createdAt: '2026-05-20T10:00:00.000Z',
  },
];

export const v1OpsOverviewFixture: V1OpsOverview = {
  queues: {
    openReports: 1,
    activeDisputes: 1,
    pendingPayments: 1,
  ...
  recentEvents: v1OpsEventsFixture,
};

export const v1OpsReportsFixture: CursorPage<V1OpsReport> = {
  items: [
    {
      reportId: 'report-1',
      ...
      targetId: 'match-1',
      reason: 'safety',
      description: '장소 안내가 실제 위치와 다릅니다.',
      status: 'reviewing',
      priority: 20,
...
export const v1OpsDisputesFixture: CursorPage<V1OpsDispute> = {
  items: [
    {
      disputeId: 'dispute-1',
      reporterUserId: 'user-3',
      targetType: 'team_match',
      targetId: 'team-match-1',
...
export const v1OpsPaymentsFixture: CursorPage<V1PaymentOrder> = {
  items: [
    {
      ...
      approvedAt: '2026-05-19T08:20:00.000Z',
      failedAt: null,
      failureCode: null,
      failureMessage: null,
      refunds: [
        {
          ...
          reviewedAt: '2026-05-19T09:00:00.000Z',
          completedAt: null,
          createdAt: '2026-05-19T09:00:00.000Z',
          updatedAt: '2026-05-19T09:00:00.000Z',
        },
...
export const v1OpsSettlementsFixture: CursorPage<V1SettlementBatch> = {
  items: [
    {
      settlementBatchId: 'settlement-1',
...
export const v1OpsAuditFixture: V1OpsAudit = {
  actionLogs: v1AdminLogsFixture.items,
  caseEvents: v1OpsEventsFixture,
};
