    ...
    <div className="flex min-h-dvh flex-col bg-white">
      ...
      <div className="flex flex-1 flex-col items-center justify-center px-6">
        ...
        <div className="w-full max-w-sm space-y-2.5">
          <button className="flex w-full items-center justify-center gap-3 rounded-xl bg-[#FEE500] px-6 py-[14px] text-[15px] font-semibold text-[#191919] opacity-40 cursor-not-allowed">
          ...
          <button className="flex w-full items-center justify-center gap-3 rounded-xl bg-[#03C75A] px-6 py-[14px] text-[15px] font-semibold text-white opacity-40 cursor-not-allowed">
          ...
          <button className="flex w-full items-center justify-center gap-3 rounded-xl bg-gray-900 px-6 py-[14px] text-[15px] font-semibold text-white opacity-40 cursor-not-allowed">
