...
export default function ChatRoomPage() {
  ...
  return (
    <>
      ...
      <div className="hidden lg:flex lg:flex-col lg:h-[calc(100dvh-5rem)] lg:-my-10 lg:-mx-8 rounded-xl overflow-hidden border border-gray-100 dark:border-gray-700">
        <ChatRoomEmbed
