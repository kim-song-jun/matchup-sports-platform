...
export default function Error({
  ...
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center px-5 text-center">
      ...
      <h2 className="text-[20px] font-bold text-gray-900 mb-2">문제가 발생했어요</h2>
      <p className="text-[14px] text-gray-500 mb-6 max-w-sm">
        일시적인 오류가 발생했어요. 다시 시도해주세요.
      </p>
      <button
        onClick={reset}
        className="rounded-xl bg-blue-500 px-6 py-3 text-[14px] font-bold text-white hover:bg-blue-600 active:scale-[0.98] transition-all duration-200"
      >
        다시 시도하기
      </button>
    </div>
