    ...
    <div className="pt-[var(--safe-area-top)] lg:pt-0 animate-fade-in">
      ...
      <div className="lg:grid lg:grid-cols-[1fr_380px] lg:gap-8">
        ...
        <div className="px-5 lg:px-0">
          {/* Image placeholder */}
          <div className="h-64 lg:h-80 rounded-xl bg-gray-100 flex items-center justify-center mb-4">
          ...
          <div className="mb-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-[12px] text-gray-500">{sportLabel[listing.sportType]}</span>
          ...
          <div className="rounded-xl bg-gray-50 border border-gray-100 p-4">
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                <p className="text-[12px] text-gray-500 mt-0.5">에스크로 결제로 안전하게 거래하세요</p>
              </div>
            </div>
          </div>
      ...
      {showDeleteConfirm && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-5">
          <div className="w-full max-w-sm rounded-2xl bg-white p-6">
            ...
            <h3 className="text-[16px] font-bold text-gray-900 text-center">매물을 삭제하시겠어요?</h3>
