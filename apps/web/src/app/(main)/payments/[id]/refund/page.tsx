...
export default function RefundRequestPage() {
  ...
  return (
    <div className="pt-[var(--safe-area-top)] lg:pt-0 pb-32">
      ...
      {/* Fixed Bottom CTA */}
      <div className="fixed bottom-0 left-0 right-0 bg-white dark:bg-gray-800 border-t border-gray-100 dark:border-gray-700 px-5 py-4 pb-[calc(1rem+var(--safe-area-bottom))] lg:relative lg:border-0 lg:px-0 lg:mt-4 lg:pb-4 max-w-lg mx-auto lg:mx-0">
