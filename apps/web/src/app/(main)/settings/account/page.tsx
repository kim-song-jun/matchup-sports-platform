      ...
      <div className="px-5 lg:px-0 max-w-2xl py-6 space-y-6">
        ...
        <div className="rounded-2xl bg-white border border-gray-100 p-5">
          ...
          <div className="flex items-center gap-3 rounded-xl bg-blue-50 px-4 py-3.5">
            ...
            <div>
              <p className="text-[14px] font-medium text-blue-700">소셜 로그인 사용 중</p>
              <p className="text-[12px] text-blue-500 mt-0.5">카카오 계정으로 로그인되어 있어 비밀번호 변경이 불가합니다.</p>
            </div>
          </div>
        </div>
          ...
          <div className="relative w-full max-w-sm rounded-3xl bg-white p-6 shadow-xl animate-fade-in">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <div className="w-full mb-4">
                <p className="text-[13px] text-gray-500 mb-2 text-left">확인을 위해 &quot;탈퇴합니다&quot;를 입력하세요</p>
                <input
                  type="text"
              ...
              <div className="flex gap-3 w-full">
                ...
                <button
                  ...
                  className="flex-1 rounded-2xl bg-red-500 py-3 text-[15px] font-semibold text-white hover:bg-red-600 transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
                >
                  탈퇴하기
                </button>
              </div>
