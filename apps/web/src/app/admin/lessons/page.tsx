...
const statusColor: Record<string, string> = { open: 'bg-emerald-50 text-emerald-600', closed: 'bg-gray-100 text-gray-500', completed: 'bg-blue-50 text-blue-600', cancelled: 'bg-red-50 text-red-500' };
