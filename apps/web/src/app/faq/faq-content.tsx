...
const FAQ_ITEMS: FaqItem[] = [
  ...
  {
    category: '서비스',
    question: 'Teameet은 어떤 서비스인가요?',
    answer:
      'Teameet은 AI 기반 멀티스포츠 소셜 매칭 플랫폼입니다. 실력, 위치, 매너 점수를 종합 분석하여 나에게 가장 적합한 운동 상대를 자동으로 찾아드립니다. 개인 매칭부터 팀 매칭까지, 축구/풋살/농구/배드민턴 등 11개 종목을 지원합니다.',
  },
  {
    category: '서비스',
  ...
  },
  {
    ...
    answer:
      'Teameet은 모바일 웹에서 바로 사용하실 수 있으며, iOS App Store와 Google Play Store에서도 앱을 다운로드하실 수 있습니다. 앱과 웹 모두 동일한 계정으로 이용 가능합니다.',
  },
  {
    category: '서비스',
  ...
  /* 매칭 */
  {
    ...
    answer:
      'Teameet의 AI 매칭은 ELO 기반 실력 점수, 선호 포지션, 활동 지역, 가능 시간대, 매너 점수 등 다양한 요소를 종합 분석합니다. 경기를 할수록 데이터가 쌓여 매칭 정확도가 더욱 높아집니다. 목표는 치열하면서도 즐거운 경기를 만드는 것입니다.',
  },
  {
    category: '매칭',
  ...
  },
  {
    ...
    answer:
      '카카오, 네이버, 애플 계정으로 간편 로그인이 가능합니다. 마이페이지 > 설정 > 계정 연동에서 추가 소셜 계정을 연동하거나 해제할 수 있습니다. 여러 소셜 계정을 하나의 Teameet 계정에 연결할 수 있습니다.',
  },
];
