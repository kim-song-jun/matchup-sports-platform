          ...
          <ScrollReveal className="mb-6">
            <div className="bg-gray-900 dark:bg-gray-800 rounded-2xl p-8 lg:p-10 text-white lg:flex lg:items-center lg:gap-10">
              <div className="flex-1">
                ...
                <div className="mt-5 flex flex-wrap gap-2">
                  {['실력 분석', '위치 매칭', '매너 필터', 'ELO 반영'].map((tag) => (
                    <span key={tag} className="inline-flex items-center gap-1 text-xs text-gray-400 bg-white dark:bg-gray-800/5 px-2.5 py-1 rounded-lg">
              ...
              <div className="mt-6 lg:mt-0 shrink-0">
                <div className="bg-white dark:bg-gray-800/5 border border-white/10 rounded-2xl p-5 w-[220px]">
                  <div className="flex items-center gap-2.5 mb-4">
                    <div className="h-9 w-9 rounded-full bg-blue-500/30 flex items-center justify-center text-sm font-bold text-blue-300">K</div>
                    <div>
                      <div className="text-sm font-semibold text-white">김민수</div>
                      <div className="text-xs text-gray-500">축구 · B등급</div>
                    </div>
                  </div>
            ...
            {STEPS.map((step, idx) => (
              <ScrollReveal key={step.num} delay={idx * 200}>
                <div className="text-center relative">
                  ...
                  <p className="text-base text-gray-500 dark:text-gray-400 leading-relaxed max-w-[260px] mx-auto">{step.description}</p>
                </div>
              </ScrollReveal>
            ))}
          </div>
              ...
              return (
                <ScrollReveal key={t.author} delay={idx * 120}>
                  <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-100 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-750 hover:-translate-y-0.5 transition-[colors,transform] duration-300 h-full flex flex-col">
                    ...
                    <p className="text-md text-gray-700 dark:text-gray-300 leading-relaxed flex-1 mb-5">
                      &ldquo;{t.quote}&rdquo;
                    </p>
