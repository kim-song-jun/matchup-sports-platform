      ...
      <div className="max-w-[1100px] mx-auto px-5">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <Link href="/" className="flex items-center gap-2.5">
            ...
            <span className="font-semibold text-gray-900 dark:text-white text-md">Teameet</span>
          </Link>
        ...
        <p className="text-xs text-gray-400 dark:text-gray-500 mt-4">&copy; 2026 Teameet. All rights reserved.</p>
      </div>
    </footer>
  );
}
