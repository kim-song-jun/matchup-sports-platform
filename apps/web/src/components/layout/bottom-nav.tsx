          ...
          return (
            <Link
              ...
              className={cn(
                ...
                isActive ? 'is-active' : 'text-gray-500 dark:text-gray-400',
              )}
            >
              ...
              <span className={cn('text-[10px] font-semibold tracking-[0.01em]', isActive ? 'text-gray-900 dark:text-white' : 'text-gray-500 dark:text-gray-400')}>{label}</span>
            </Link>
          );
        })}
      </div>
