...
describe('useRealtime', () => {
  ...
  it('registers connect/disconnect/connect_error event handlers', () => {
    ...
    const registeredEvents = mockOn.mock.calls.map((c: unknown[]) => c[0] as string);
  ...
  it('transitions to connected state on connect event', () => {
    ...
    const connectHandler = mockOn.mock.calls.find((c: unknown[]) => c[0] === 'connect')?.[1] as (() => void) | undefined;
    act(() => {
      connectHandler?.();
    });
  ...
  it('transitions to disconnected state on disconnect event', () => {
    ...
    const disconnectHandler = mockOn.mock.calls.find((c: unknown[]) => c[0] === 'disconnect')?.[1] as (() => void) | undefined;
  ...
  it('transitions to error state on connect_error event', () => {
    ...
    const errHandler = mockOn.mock.calls.find((c: unknown[]) => c[0] === 'connect_error')?.[1] as ((err: Error) => void) | undefined;
  ...
  it('removes event listeners on cleanup', () => {
    ...
    const offEvents = mockOff.mock.calls.map((c: unknown[]) => c[0] as string);
