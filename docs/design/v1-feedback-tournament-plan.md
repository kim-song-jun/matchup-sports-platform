...
> **상태**: 🟢 골격 결정 + IA 재정의 확정(2026-06-13). 버그픽스 먼저 / 신규 Tournament 도메인 / PG 포함 / realName 대회 신청 시 / 알림 전체확장 / **navbar 5탭(홈·매치·대회·팀·마이) · 매치=개인+팀 병존 · 대회=상금+구조**(§G 참고). 선출여부(6)는 Wave2 착수 시 확정. **Wave1+1.5 버그픽스 커밋 완료(bd5d6377)** · **Wave1.6 IA 재정의(navbar 5탭·매치 개인/팀 세그먼트·대회 skeleton·홈 추천) 구현·검증 완료**. 다음: 대회 도메인(Wave2~3).
...
| 6 | 선출여부 판단 주체 | 권고: 자기신고 + 어드민 검토(needs_review) | ⬜ Wave2 착수 시 |
