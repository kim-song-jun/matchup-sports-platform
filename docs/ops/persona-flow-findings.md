...
### ✅ Batch B — tournament/정산 (완료 `9d6b5bef`)
...
### ✅ Batch C — auth/onboarding (완료 `d6ff2916`)
...
### ✅ Batch D — team-matches/copy/community (완료 `54c129f8`) + 백엔드 #21 해요체 전수 3서비스(`af632b58`, v1_api 33 tests)
