...
- [x] 자책골은 상대 팀 선수를 선택하고 득점 팀 점수만 증가시킨다. 일정·상세·팀 전적에서는 자책골 선수를 실제 소속팀 영역에 표시하며 개인 득점에는 포함하지 않는다.
...
- [x] 승부차기는 기본 3회이며, 역전 불가 시 양 팀 킥 수가 달라도 조기 종료한다.
- [x] 3회 후 동점이면 횟수 제한 없이 서든데스를 진행하고, 양 팀 응답 킥 한 쌍 뒤 판정한다.
