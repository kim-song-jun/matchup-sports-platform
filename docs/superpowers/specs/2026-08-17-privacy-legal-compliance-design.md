...
> 이 표에는 **이 스펙이 확정하는 결정만** 넣는다. 법무·사용자 게이트가 필요한 항목(탈퇴 유예기간 길이, 3년 만료 시 realName 처분, 제재 이력 보유자의 파기 유예 방식)은 **전부 §10 미결**에 있다 — 미확정을 확정 표에 넣지 않는다. (**대회 기록 참가자 이름 표시 방향**은 2026-08-18 사용자 결정으로 확정되어 §10.2-Q1에서 이 표의 P-9로 이관됐다 — §5.2)
