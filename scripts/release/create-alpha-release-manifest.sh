...
if [[ "${1:-}" == '--self-test' ]]; then
  ...
  TASK168_SCHEMA_SHA256=58b05adaedc4e53461167c4efa1c101e1297297b122db6a173b06f899fb2e7d9
...
[[ "$TASK168_SCHEMA_SHA256" == 58b05adaedc4e53461167c4efa1c101e1297297b122db6a173b06f899fb2e7d9 && "$TASK168_M11_SHA256" == 08eac7347cbb10fcc4ef87d31d63bd9516d5bfda281dcf5730c4f0a1985d9323 ]] || { echo 'Task168 final-policy binding mismatch' >&2; exit 1; }
